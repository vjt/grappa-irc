defmodule GrappaWeb.AuthController do
  ...
  # nil-client bypass was the whole bug). Spelled explicitly alongside its
  # siblings so it reaches FallbackController's 503 too_many_sessions
  # envelope instead of the catch-all `:internal` 500 below.
